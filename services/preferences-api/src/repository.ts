...
export class PreferencesRepository {
  ...
  async upsertPreferences(
    ...
    const record: UserPreferencesRecord = {
      ...
      selectedTransitModes: input.selectedTransitModes,
      minBedrooms: input.minBedrooms,
      maxBedrooms: input.maxBedrooms,
      minBathrooms: input.minBathrooms,
      minSquareFeet: input.minSquareFeet,
      maxSquareFeet: input.maxSquareFeet,
      hasGym: input.hasGym,
      hasPool: input.hasPool,
      hasLaundry: input.hasLaundry,
    ...
    await this.docClient.send(
      new PutCommand({
        ...
        Item: {
          ...
          selected_transit_modes: record.selectedTransitModes,
          min_bedrooms: record.minBedrooms,
          max_bedrooms: record.maxBedrooms,
          min_bathrooms: record.minBathrooms,
          min_square_feet: record.minSquareFeet,
          max_square_feet: record.maxSquareFeet,
          has_gym: record.hasGym,
          has_pool: record.hasPool,
          has_laundry: record.hasLaundry,
          utilities_included: record.utilitiesIncluded,
          has_parking: record.hasParking,
          pet_friendly: record.petFriendly,
          furnished: record.furnished,
          air_conditioning: record.airConditioning,
          has_balcony: record.hasBalcony,
